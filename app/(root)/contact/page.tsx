...
>>>>>>> fc5120980ea5a169536745848a3160707931147e
import {
	Form,
	FormControl,
	FormField,
		...
		return (
			(!IsSuccessful?
				...
				render={({ field }) => (
					...
					<Input {...field} className="h-12 focus-visible:ring-0 focus-visible:ring-transparent focus-visible:ring-offset-0" />
					</FormControl>
					<FormMessage />
					</FormItem>
					)}
					...
					render={({ field }) => (
						<FormItem>
						<FormLabel className="text-base font-semibold">Business</FormLabel>
						<FormControl className="bg-[#F5F5F5]">
						<Input {...field} className="h-12 focus-visible:ring-0 focus-visible:ring-transparent focus-visible:ring-offset-0" />
						</FormControl>
						<FormMessage />
						...
						render={({ field }) => (
							<FormItem>
							<FormLabel className="text-base font-semibold">Contact No.</FormLabel>
							<FormControl className="bg-[#F5F5F5]">
							<Input {...field} className="h-12 focus-visible:ring-0 focus-visible:ring-transparent focus-visible:ring-offset-0" />
							</FormControl>
							<FormMessage />
							...
							render={({ field }) => (
								...
								<span className="justify-start text-lg font-semibold pt-10">Which services are you interested in...</span>
								...
								render={({ field }) => (
									...
									<FormLabel className="text-lg font-semibold">Tell us more about your business</FormLabel>
									<FormControl>
									<Textarea placeholder="About your business" {...field} className="bg-[#F5F5F5] w-[90%] h-[20vh] p-3 rounded-xl focus-visible:ring-0 focus-visible:ring-transparent focus-visible:ring-offset-0" />
									</FormControl>
									<FormMessage />
									</FormItem>
									)}
									...
									<Button type="submit" className="rounded-full text-lg text-white p-4 place-items-center mb-10 me-10">
									Submit Request
									...
									{uploading ? (<div
										...
										<span className="font-bold bg-gradient-to-r from-[#9747FF] via-[#6052FA] to-[#E07E71] bg-clip-text text-transparent text-6xl">Thank You!</span>
										<span className="text-[#4D4D4] text-xl md:text-3xl">
										<br/>Your request has been successfully sent 🤝<br/>Wait for a response from our manager.
										</span>
										</div>
